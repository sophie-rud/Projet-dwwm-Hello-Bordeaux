 ...
 */
final class Version20240808165438 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE activity ADD user_admin_organizer_id INT NOT NULL');
        $this->addSql('ALTER TABLE activity ADD CONSTRAINT FK_AC74095A526909CC FOREIGN KEY (user_admin_organizer_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_AC74095A526909CC ON activity (user_admin_organizer_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE activity DROP FOREIGN KEY FK_AC74095A526909CC');
        $this->addSql('DROP INDEX IDX_AC74095A526909CC ON activity');
        $this->addSql('ALTER TABLE activity DROP user_admin_organizer_id');
    }
}
